/*
  ...
  1. Database Trigger Optimization
    - Simplified trigger function for faster execution
    - Added ON CONFLICT handling to prevent duplicate key errors
    - Streamlined user creation with minimal database operations
  ...
  3. RLS Policy Optimization
    - Streamlined RLS policies with simpler logic
...
-- Optimize indexes for faster queries (without CONCURRENTLY)
...
-- Create optimized indexes (regular CREATE INDEX)
...
-- Create streamlined RLS policies with simple names
